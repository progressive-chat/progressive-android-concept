...
const char* llm_stateToString(LlmState s) {
    switch (s) {
        case LlmState::UNKNOWN: return "UNKNOWN";
        case LlmState::INIT: return "INIT";
        case LlmState::PROCESSING: return "PROCESSING";
        case LlmState::DONE: return "DONE";
        case LlmState::ERROR: return "ERROR";
        default: return "UNKNOWN";
    }
}

LlmState llm_stateFromString(const std::string& s) {
    if (s == "UNKNOWN") return LlmState::UNKNOWN;
    if (s == "INIT") return LlmState::INIT;
    if (s == "PROCESSING") return LlmState::PROCESSING;
    if (s == "DONE") return LlmState::DONE;
    if (s == "ERROR") return LlmState::ERROR;
    return LlmState::UNKNOWN;
}
...
LlmResponse llm_handle(const LlmRequest& req) {
    ...
    g_status.state = LlmState::PROCESSING;
    // Validate request
...
void llm_reset() {
    ...
    g_config = LlmConfig{};
    g_status = LlmStatus{};
    g_status.state = LlmState::UNKNOWN;
}
