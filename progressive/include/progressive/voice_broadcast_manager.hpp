...
enum class VoiceBroadcastManagerState {
    UNKNOWN = 0,
    INIT = 1,
    PROCESSING = 2,
    DONE = 3,
...
struct VoiceBroadcastManagerConfig {
...
struct VoiceBroadcastManagerRequest {
...
struct VoiceBroadcastManagerResponse {
    bool success = false;
...
struct VoiceBroadcastManagerStatus {
    VoiceBroadcastManagerState state = VoiceBroadcastManagerState::UNKNOWN;
...
struct VoiceBroadcastManagerStats {
...
// Initialize the voice broadcast manager module with configuration
bool voice_broadcast_manager_init(const VoiceBroadcastManagerConfig& config);

// Handle a voice broadcast manager request, returning a response
