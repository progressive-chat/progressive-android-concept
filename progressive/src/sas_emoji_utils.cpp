...
namespace {
    SasEmojiUtilsConfig g_config;
    std::mutex g_mutex;
    SasEmojiUtilsStatus g_status;
    SasEmojiUtilsStats g_stats;
    bool g_initialized = false;
} // anonymous namespace

const char* sas_emoji_utils_stateToString(SasEmojiUtilsState s) {
    switch (s) {
        case SasEmojiUtilsState::UNKNOWN: return "UNKNOWN";
        case SasEmojiUtilsState::INIT: return "INIT";
        case SasEmojiUtilsState::PROCESSING: return "PROCESSING";
        case SasEmojiUtilsState::DONE: return "DONE";
        case SasEmojiUtilsState::ERROR: return "ERROR";
        default: return "UNKNOWN";
    }
}

SasEmojiUtilsState sas_emoji_utils_stateFromString(const std::string& s) {
    if (s == "UNKNOWN") return SasEmojiUtilsState::UNKNOWN;
    if (s == "INIT") return SasEmojiUtilsState::INIT;
    if (s == "PROCESSING") return SasEmojiUtilsState::PROCESSING;
    if (s == "DONE") return SasEmojiUtilsState::DONE;
    if (s == "ERROR") return SasEmojiUtilsState::ERROR;
    return SasEmojiUtilsState::UNKNOWN;
}
...
bool sas_emoji_utils_init(const SasEmojiUtilsConfig& config) {
    ...
    g_config = config;
    g_initialized = true;
    g_status.state = SasEmojiUtilsState::INIT;
...
SasEmojiUtilsResponse sas_emoji_utils_handle(const SasEmojiUtilsRequest& req) {
    ...
    g_status.state = SasEmojiUtilsState::PROCESSING;
    // Validate request
...
void sas_emoji_utils_reset() {
    std::lock_guard<std::mutex> lock(g_mutex);
    g_initialized = false;
    g_config = SasEmojiUtilsConfig{};
    g_status = SasEmojiUtilsStatus{};
    g_status.state = SasEmojiUtilsState::UNKNOWN;
}
